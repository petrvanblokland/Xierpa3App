...
plist = dict(CFBundleIdentifier="com.petr.xierpa3app", LSMinimumSystemVersion="10.6.0",
             CFBundleShortVersionString="1.0.0", CFBundleVersion="1.0.0", CFBundleIconFile="icon.icns",)
